...
ggcorrplot(corr_mat, hc.order = TRUE, outline.col = "white", lab=TRUE, lab_size=5,
                type = "upper")
...
write.csv(DF1,"C:path/to/income_prediction/datasets/realTrainData.csv", row.names = FALSE)
